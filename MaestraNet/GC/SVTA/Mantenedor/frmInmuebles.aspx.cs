...
{
    public partial class frmInmuebles : System.Web.UI.Page
    {
        ...
        protected void btnEditarInmueble_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("frmInmuebleDetalle.aspx?IdInmueble=" + theHiddenField.Value);
        }
        ...
        {
            Session["Proyecto"] = ddlProyecto.SelectedValue;
            Response.Redirect("frmInmuebleDetalle.aspx");
        }
