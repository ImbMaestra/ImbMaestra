<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmTipoInmuebleDetalle.aspx.cs" Inherits="MaestraNet.GC.SVTA.Mantenedor.frmTipoInmuebleDetalle" %>
            ...
            <tr>
                <td>
                    <asp:Panel ID="pnDatosProyecto" runat="server">
                        ...
                        <asp:Label ID="lblidTipoInmueble" runat="server" Visible="false"></asp:Label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <label for="Proyecto">
                                                        Tipo Inmueble:
                                                <br />
                                                        <asp:TextBox ID="txtTipoInmueble" runat="server" Width="180px" CssClass="BordeRadio10" BackColor="Yellow"></asp:TextBox>
                                                    </label>
                                                </div>
                                                <div class="col-md-3">
                                                    <label for="Region">
                                                        CdiId :
                                                <br />
                                                       <asp:TextBox ID="txtCdiId" runat="server" Width="180px" CssClass="BordeRadio10" BackColor="Yellow"></asp:TextBox>
                                                    </label>
                                                </div>
                                                <div class="col-md-2">
                                                    <label for="Comuna">
                                                        Servicio Id:
                                                <br />
                                                        <asp:TextBox ID="txtServicioId" runat="server" Width="180px" CssClass="BordeRadio10" BackColor="Yellow"></asp:TextBox>
                                                    </label>
