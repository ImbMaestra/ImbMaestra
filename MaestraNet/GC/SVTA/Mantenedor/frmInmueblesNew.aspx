<%@ Page Language="C#" maintainScrollPositionOnPostBack="true" AutoEventWireup="true" CodeBehind="frmInmueblesNew.aspx.cs" Inherits="MaestraNet.GC.SVTA.Mantenedor.frmInmueblesNew" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Mantenedor Inmueble New</title>
</head>
<body>
                    ...
                    <div id="GrillaInmueble">
                        ...
                        <fieldset class="principal">
                            ...
                            <tr>
                                <td colspan="4" align="right">
                                    <asp:LinkButton ID="btnEdicionMasiva" runat="server" CssClass="botoMaestra btn"  ToolTip="Carga Inmueble" OnClick="btnEdicionMasiva_Click">
                                        Edición Masiva <span class="oi oi-pencil"></span>
                                    </asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                        <br />
                            <asp:GridView ID="gvInmuebles" runat="server" CellPadding="4" AutoGenerateColumns="False"
                                    ...
                                    AllowPaging="True" AllowSorting="True" OnPageIndexChanging="gvInmuebles_PageIndexChanging" onpageindexchanged="gvProducts_PageIndexChanged" CssClass="grid_data" PageSize="10">
