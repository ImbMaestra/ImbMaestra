<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmProyectos.aspx.cs" Inherits="MaestraNet.GC.SVTA.Mantenedor.frmProyectos" %>
            ...
            <tr>
                <td>
                    ...
                    <fieldset class="principal">
                        <legend>
                            <asp:Label runat="server" Text="Buscar Proyecto" CssClass="principal"></asp:Label>
                        </legend>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label for="Region"> Región: &nbsp;</label>
                                        <asp:DropDownList ID="ddpRegion" runat="server" CssClass="BordeRadio10" DataSourceID="SqlDataSource1" DataTextField="RegNombre" DataValueField="RegCodigo" AutoPostBack="True"></asp:DropDownList>
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Sistemas_Maestra %>"
                                            SelectCommand="sp_VTA_Combo_Regiones_Disp" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                                    
                                </div>
                                <div class="col-md-3">
                                     <label for="Comuna">
                                        Comuna: &nbsp;
                                        <asp:DropDownList ID="ddpComuna" runat="server" CssClass="BordeRadio10" DataSourceID="SqlDataSource2" DataTextField="CmuNombre" DataValueField="CmuCodigo"></asp:DropDownList>
                                        <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                                            ConnectionString="<%$ ConnectionStrings:Sistemas_Maestra %>"
                                            SelectCommand="sp_VTA_Combo_Comunas_Disp" SelectCommandType="StoredProcedure">
                                            <SelectParameters>
                                                <asp:ControlParameter ControlID="ddpRegion" Name="region" PropertyName="SelectedValue" Type="Int32" />
                                            </SelectParameters>
                                        </asp:SqlDataSource>
                                    </label>
                                </div>
                                <div class="col-md-4">
                                     <label for="EstadoEntrega">
                                        Estado Entrega: &nbsp;
                                        <asp:DropDownList ID="ddlEstado" runat="server" CssClass="BordeRadio10" DataSourceID="sdsEstado" DataTextField="nombre" DataValueField="IdEstadoEntrega"></asp:DropDownList>
                                        <asp:SqlDataSource ID="sdsEstado" runat="server"
                                            ConnectionString="<%$ ConnectionStrings:Sistemas_Maestra %>"
            ...
            <tr>
                <td>
                    <div id="GrillaClientes">
                        ...
                        <fieldset class="principal">
                            <legend>
                                <asp:Label ID="lblLista" runat="server" Text=" Seleccione Proyecto" CssClass="principal"></asp:Label>
                            </legend>
                            <table width="100%">
                            <tr>
                                <td width="80%">
