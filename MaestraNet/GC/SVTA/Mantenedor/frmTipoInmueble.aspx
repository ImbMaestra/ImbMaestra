<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmTipoInmueble.aspx.cs" Inherits="MaestraNet.GC.SVTA.Mantenedor.frmTipoInmueble" %>
            ...
            <tr>
                <td>
                    ...
                    <fieldset class="principal">
                        <legend>
                            <asp:Label runat="server" Text="Buscar Tipo Inmueble" CssClass="principal"></asp:Label>
                        </legend>
            ...
            <tr>
                <td>
                    <div id="GrillaClientes">
                        ...
                        <fieldset class="principal">
                            <legend>
                                <asp:Label ID="lblLista" runat="server" Text="Seleccione Tipo Inmueble" CssClass="principal"></asp:Label>
                            </legend>
                            <table width="100%">
                            <tr>
                                <td width="80%">
                        ...
                        <br />
                            <asp:GridView ID="gvTipoInmueble" runat="server" CellPadding="4" AutoGenerateColumns="False"
                                    OnSorting="gvTipoInmueble_Sorting" OnDataBound="gvTipoInmueble_DataBound" OnRowDataBound="gvTipoInmueble_RowDataBound"
                                    AllowPaging="True" AllowSorting="True" OnPageIndexChanging="gvTipoInmueble_PageIndexChanging" CssClass="grid_data" PageSize="10">
                                <AlternatingRowStyle CssClass="grid_linea_alterna" />
                                <Columns>
                                    <asp:BoundField DataField="Nombre" HeaderText="Nombre" ReadOnly="True" SortExpression="nombre" HeaderStyle-Font-Underline="true" ControlStyle-Font-Underline="true" />
                                    <asp:BoundField DataField="CdiId" HeaderText="CdiId" ReadOnly="True" SortExpression="CdiId" HeaderStyle-Font-Underline="true" />
                                    <asp:TemplateField HeaderText="Editar" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnEditarTipoInmueble" CssClass="btn grid_boton" runat="server" Text="Editar" OnClick="btnEditarTipoInmueble_Click" ForeColor="#ffffff"> <i class="oi oi-pencil"></i>
                                            </asp:LinkButton>
                                            <asp:LinkButton ID="btnEliminarTipoInmueble" CssClass="btn grid_boton" runat="server" Text="Eliminar" OnClientClick="return window.confirm('Seguro de eliminar el Tipo de Inmueble?')" OnClick="btnEliminarTipoInmueble_Click" ForeColor="#ffffff" ToolTip="Eliminar Tipo Inmueble"> <i class="oi oi-trash"></i>
                                            </asp:LinkButton>
                                            <asp:HiddenField ID="HiddenFieldDifferentUsers" Value='<%# Eval("IdTipoInmueble") %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
